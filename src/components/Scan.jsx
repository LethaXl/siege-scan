          ...
          <div className="space-y-4 landscape:space-y-1 flex flex-col items-center landscape:items-center">
            <div className="w-full max-w-md landscape:max-w-lg landscape:px-4 landscape:flex landscape:gap-2 landscape:items-center">
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 landscape:py-2 rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all transform hover:scale-105 shadow-lg"
              >
                Take Photo
              </button>
              <input
              ...
              <div className="relative w-full my-4 landscape:hidden">
              ...
              <span className="hidden landscape:block landscape:mx-2 text-gray-500 dark:text-gray-400">or</span>

              <div
                {...getRootProps()}
                className={`w-full border-2 border-dashed rounded-lg p-6 landscape:p-3 text-center cursor-pointer transition-colors
                  ${isDragActive 
